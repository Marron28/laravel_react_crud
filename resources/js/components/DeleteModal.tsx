    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
            <div className="bg-neutral-50 rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4 text-center">
                ...
                <h1 className="text-lg text-center font-semibold">Delete</h1>
                <p className="text-sm mb-6">Are you sure you want to delete this?</p>
                <div className="flex gap-6 justify-center">
                    <TechMaxButton onClick={onConfirm} label="Yes" />
                    <TechMaxButton
